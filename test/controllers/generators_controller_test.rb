...
class GeneratorsControllerTest < ActionController::TestCase
  ...
  test "should create generator" do
    assert_difference('Generator.count') do
      post :create, generator: { primer_length: @generator.primer_length, random_primer_generated: @generator.random_primer_generated }
    end
  ...
  test "should update generator" do
    patch :update, id: @generator, generator: { primer_length: @generator.primer_length, random_primer_generated: @generator.random_primer_generated }
    assert_redirected_to generator_path(assigns(:generator))
  end
